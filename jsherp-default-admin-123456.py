...
def check_login(site):
    ...
    postdata={"code": code, "loginName": "admin", "password": "e10adc3949ba59abbe56e057f20f883e", "uuid": uuid}
    try:
...
if __name__=="__main__":
    target = sys.argv[1]
    print("Microsoft Windows [版本 10.0.19044.3086]\n(c) Microsoft Corporation。保留所有权利。\n\nD:\VulnSubmit\script>python3 jsherp-default-admin-123456.py ",target)
    verify(target)
